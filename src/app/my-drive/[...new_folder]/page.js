...
const NewFolder = ({ params : { new_folder }}) => {
  return (
  <>
      {/* loader Start */}
      {/* <div id="loading">
          ...
          <div className="navbar-breadcrumb">
            <nav aria-label="breadcrumb">
              <ul className="breadcrumb mb-0">
                <li className="breadcrumb-item"><a href="index.html">My Drive</a></li>
                {new_folder.map((folder_name) => (
                <li className="breadcrumb-item active" aria-current="page" key={folder_name._id}>{folder_name
                }</li>
                ))}
              </ul>
            </nav>
