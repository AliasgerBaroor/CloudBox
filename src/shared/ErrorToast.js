...
const ErrorToast = ({title, msg}) => {
  ...
  <div className="toast fade show bg-info text-white rounded p-3" role="alert" aria-live="assertive" aria-atomic="true">
    <div className="toast-header bg-info text-white d-flex justify-content-between align-items-center">
